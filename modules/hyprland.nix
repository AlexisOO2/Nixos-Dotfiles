	...
	settings = {
		...
		animations = {
			...
			animation = [
				...
				"workspaces, 1, 2.25, easeInOutSine, slide"
				"workspacesIn, 1, 2.25, easeInOutSine, slide"
				"workspacesOut, 1, 2.25, easeInOutSine, slide"
				"specialWorkspace, 1, 2.25, easeInOutSine, slidevert"
			];
		};
		dwindle = {
