	...
	settings = {
		...
		animations = {
			...
			animation = [
				...
				"workspaces, 1, 2.0, easeInOutSine, slide"
				"workspacesIn, 1, 2.0, easeInOutSine, slide"
				"workspacesOut, 1, 2.0, easeInOutSine, slide"
				"specialWorkspace, 1, 2.0, easeInOutSine, slidevert"
			];
		};
		dwindle = {
